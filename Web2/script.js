...
let currentTruthTableHTML = "";
/* =========================================================
   GATE SVG HELPERS — clean schematic style
========================================================= */
function gateXOR(cx, cy, w, h, label = "XOR") {
    const hw = w / 2, hh = h / 2;
    return `
...
function gateAND(cx, cy, w, h, label = "AND") {
    const hw = w / 2, hh = h / 2;
    return `
...
function gateOR(cx, cy, w, h, label = "OR") {
    const hw = w / 2, hh = h / 2;
    return `
        <path d="M ${cx - hw} ${cy - hh} Q ${cx - hw + 18} ${cy} ${cx - hw} ${cy + hh}
                 Q ${cx + 10} ${cy + hh} ${cx + hw} ${cy}
...
const circuits = {
    ...
    halfAdder: {
        ...
        renderDiagram(inp) {
            var _a, _b;
            const a = (_a = inp.A) !== null && _a !== void 0 ? _a : 0, b = (_b = inp.B) !== null && _b !== void 0 ? _b : 0;
    ...
    fullAdder: {
        ...
        renderDiagram(inp) {
            var _a, _b, _c;
            const a = (_a = inp.A) !== null && _a !== void 0 ? _a : 0, b = (_b = inp.B) !== null && _b !== void 0 ? _b : 0, cin = (_c = inp.Cin) !== null && _c !== void 0 ? _c : 0;
            const s1 = a ^ b, c1 = a & b;
    ...
    rippleCarryAdder4: {
        ...
        evaluate(inp) {
            ...
            const sums = [];
            for (let i = 0; i < 4; i++) {
                const a = (_a = inp[`A${i}`]) !== null && _a !== void 0 ? _a : 0;
                const b = (_b = inp[`B${i}`]) !== null && _b !== void 0 ? _b : 0;
                sums.push(a ^ b ^ carry);
                carry = (a & b) | (carry & (a ^ b));
            }
            return {
        ...
        renderDiagram(inp) {
            ...
            const bits = [0, 1, 2, 3];
            let carries = [(_a = inp.Cin) !== null && _a !== void 0 ? _a : 0];
            const sums = [];
            bits.forEach(i => {
                var _a, _b;
                const a = (_a = inp[`A${i}`]) !== null && _a !== void 0 ? _a : 0;
    ...
    fullSubtractor: {
        ...
        renderDiagram(inp) {
            var _a, _b, _c;
            const a = (_a = inp.A) !== null && _a !== void 0 ? _a : 0, b = (_b = inp.B) !== null && _b !== void 0 ? _b : 0, bin = (_c = inp.Bin) !== null && _c !== void 0 ? _c : 0;
    ...
    rippleBorrowSubtractor4: {
        ...
        renderDiagram(inp) {
            var _a;
            const bits = [0, 1, 2, 3];
            let borrows = [(_a = inp.Bin) !== null && _a !== void 0 ? _a : 0];
            const diffs = [];
            bits.forEach(i => {
                var _a, _b;
                const a = (_a = inp[`A${i}`]) !== null && _a !== void 0 ? _a : 0;
    ...
    mux2to1: {
        ...
        renderDiagram(inp) {
            var _a, _b, _c;
            const i0 = (_a = inp.I0) !== null && _a !== void 0 ? _a : 0, i1 = (_b = inp.I1) !== null && _b !== void 0 ? _b : 0, s = (_c = inp.S) !== null && _c !== void 0 ? _c : 0;
            const y = s ? i1 : i0;
    ...
    mux4to1: {
        ...
        renderDiagram(inp) {
            var _a, _b;
            const i = [0, 1, 2, 3].map(k => { var _a; return (_a = inp[`I${k}`]) !== null && _a !== void 0 ? _a : 0; });
            const s0 = (_a = inp.S0) !== null && _a !== void 0 ? _a : 0, s1 = (_b = inp.S1) !== null && _b !== void 0 ? _b : 0;
            const sel = (s1 << 1) | s0;
            const y = i[sel];
    ...
    mux8to1: {
        ...
        renderDiagram(inp) {
            var _a, _b, _c;
            const i = [0, 1, 2, 3, 4, 5, 6, 7].map(k => { var _a; return (_a = inp[`I${k}`]) !== null && _a !== void 0 ? _a : 0; });
            const s0 = (_a = inp.S0) !== null && _a !== void 0 ? _a : 0, s1 = (_b = inp.S1) !== null && _b !== void 0 ? _b : 0, s2 = (_c = inp.S2) !== null && _c !== void 0 ? _c : 0;
...
function showStep2(category) {
    ...
    categoryBtns.forEach(b => b.classList.remove("selected"));
    (_a = document.querySelector(`[data-category="${category}"]`)) === null || _a === void 0 ? void 0 : _a.classList.add("selected");
    switch (category) {
        case "adder":
...
========================================================= */
function buildInputPanel(circuit) {
...
========================================================= */
function readCurrentInputs(circuit) {
    const vals = {};
    circuit.inputs.forEach(name => {
        var _a;
        const toggle = inputPanel.querySelector(`[data-input="${name}"]`);
        const active = toggle === null || toggle === void 0 ? void 0 : toggle.querySelector(".input-toggle-btn.active");
        vals[name] = Number((_a = active === null || active === void 0 ? void 0 : active.getAttribute("data-value")) !== null && _a !== void 0 ? _a : 0);
    });
    return vals;
}
...
========================================================= */
function buildFullTruthTable(circuit) {
    ...
    for (let r = 0; r < rows; r++) {
        ...
        circuit.outputs.forEach(name => {
            var _a;
            const v = (_a = outputs[name]) !== null && _a !== void 0 ? _a : 0;
...
function highlightTruthTableRow(circuit, currentInputs) {
...
/* =========================================================
   EXPRESSIONS
========================================================= */
function showExpressions(circuit) {
    let html = "";
